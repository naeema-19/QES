  ...
  <div className="container-fluid blog py-5">
    <div className="container py-5">
      ...
      >
        ...
        <p className="mb-20">
        QES targeted Omanisation on start of more than 95% of local with 100% Omani owned company. QES team consists of a
        range of top Omani expertise. QES only hired an expat lab manager which has an objective of training Omani lab
        technicians. Below shows QES Omanization Plan for the next 5 years:
            ...
            <tbody>
              {[
                ...
                <tr key={index} className={index % 2 === 0 ? "row-even" : ""}>
                  <td className="first-column">{row[0]}</td>
