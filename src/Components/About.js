...
const About = () => {
  return (
    <section id='about' className=' w-screen min-h-screen'>
      <div className='text-center max-container flex justify-center items-center gap-24 padding-hero-y padding-x h-full max-xl:gap-7 max-lg:flex-col'>
        <div className=' flex-1 w-full'>
          <div className=' bg-[#35c42f] flex justify-end pt-10 pl-10 max-sm:pt-5 max-sm:pl-5'>
            <img src={img} alt="aboutImg" className=' object-cover object-center max-lg:w-full'/>
          </div>
        </div>

        <div className=' flex-1'>
          <p className=' text-[#35c42f] text-left relative before:absolute before:w-20 before:h-1 before:bg-[#35c42f] before:top-[50%] before:left-0 pl-24 text-2xl before:translate-y-[-50%]'>ABOUT US</p>
          ...
          <button className=' py-4 px-9 text-xl group relative text-white bg-[#35c42f] rounded-sm'>
